...
#
#    Then grabbed by Alex Buchanan and used in this "interval" package.
#    So far, I (Alex) have only done some basic cleanup:
#    - removed IntervalNode.intersect
#    - removed "strand" from Interval
#    - removed dead neighbor code
